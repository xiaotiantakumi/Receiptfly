...
export const DEFAULT_ACCOUNT_TITLES: Omit<AccountTitle, 'id'>[] = [
  { name: '消耗品費', isDefault: true, isFavorite: true, sortOrder: 1 },
  { name: '旅費交通費', isDefault: true, isFavorite: true, sortOrder: 2 },
  { name: '接待交際費', isDefault: true, isFavorite: true, sortOrder: 3 },
  ...
  { name: '会議費', isDefault: true, isFavorite: true, sortOrder: 8 },
  { name: '事業主貸', isDefault: true, isFavorite: false, sortOrder: 9 },
  { name: 'その他', isDefault: true, isFavorite: true, sortOrder: 10 },
];

export const DEFAULT_CATEGORIES: Omit<Category, 'id'>[] = [
  { name: '食費', isDefault: true, isFavorite: true, sortOrder: 1 },
  { name: '事務用品', isDefault: true, isFavorite: true, sortOrder: 2 },
  { name: '交通費', isDefault: true, isFavorite: true, sortOrder: 3 },
  { name: '通信費', isDefault: true, isFavorite: false, sortOrder: 4 },
  { name: '消耗品', isDefault: true, isFavorite: true, sortOrder: 5 },
  { name: '会議・打ち合わせ', isDefault: true, isFavorite: false, sortOrder: 6 },
  { name: '接待・交際', isDefault: true, isFavorite: false, sortOrder: 7 },
  { name: 'その他', isDefault: true, isFavorite: false, sortOrder: 8 },
];
