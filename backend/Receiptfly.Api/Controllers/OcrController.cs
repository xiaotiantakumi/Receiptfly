...
public class OcrController : ControllerBase
{
    ...
    public OcrController(IImageStorageService imageStorageService, IOcrService ocrService)
    {
    ...
    public async Task<IActionResult> ProcessImage(IFormFile file, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            // OCR処理
            var ocrResult = await _ocrService.ExtractTextAsync(filePath, cancellationToken);
